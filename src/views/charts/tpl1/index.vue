...
#tpl1 {
  ...
  background: rgb(40, 30, 47) url("/images/tpl1/bg.png") 0 0 no-repeat;
...
#header {
  position: relative;
  height: 72px;
  background: url("/images/tpl1/header.png") 0 0 no-repeat;
  background-size: 100% 100%;
  overflow: hidden;
}
.header-title {
...
#footer {
  ...
  right: 0;
  height: 24px;
  background: url("/images/tpl1/footer.png") 0 0 no-repeat;
  background-size: 100% 100%;
}
#container {
  position: absolute;
