...
<style lang="less" scoped>
  * {
  ...
  #tpl3 {
    ...
    background: #050d3c url("/images/tpl3/bg.png") 0 0 no-repeat;
  ...
  #header {
    position: relative;
    height: 72px;
    background: url("/images/tpl3/header.png") 0 0 no-repeat;
    background-size: 100% 100%;
    overflow: hidden;
  }
  ...
  .chart-div {
    ...
    border-image: url("/images/tpl3/chart-wrapper.png") 26 27 27 fill repeat;
  }
