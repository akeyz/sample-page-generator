...
<style lang="less" scoped>
  * {
  ...
  #tpl2 {
    ...
    background: #0a1631 url("/images/tpl2/bg.png") 0 0 no-repeat;
  ...
  #header {
    position: relative;
    height: 72px;
    background: url("/images/tpl2/header.png") 0 0 no-repeat;
    background-size: 100% 100%;
    overflow: hidden;
  }
  ...
  #footer {
    ...
    right: 0;
    height: 24px;
    background: url("/images/tpl2/footer.png") 0 0 no-repeat;
    background-size: 100% 100%;
  }
